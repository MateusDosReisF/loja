                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="complement" type="text" class="form-control @error('complement') is-invalid @enderror" name="complement" value="{{ old('complement') }}" autocomplete="complement" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="state" class="col-md-4 col-form-label text-md-right">{{ __('UF:') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="reference" class="col-md-4 col-form-label text-md-right">{{ __('Referência:') }}</label>
    ...
    <script>
        $(document).ready(function(){
            $('#zipcode').on('keyup', function(){
                let cep = $(this).val();
                if(cep.length == 8){
                    $.get('http://localhost:8000/ws/cep/' + cep)
